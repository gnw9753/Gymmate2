package com.example.gymmate.calories;
...
import com.example.gymmate.data.FoodModel;
...
public class CaloriesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root=inflater.inflate(R.layout.activity_calories, container, false);
        tv_calDisplay = root.findViewById(R.id.tv_calDisplay);
        btn_addFood = root.findViewById(R.id.btn_addFood);
        btn_addWeight = root.findViewById(R.id.btn_addWeight);
        btn_weight_update_cancel = root.findViewById(R.id.btn_weight_update_cancel);
        btn_food_add_cancel = root.findViewById(R.id.btn_food_add_cancel);
        btn_food_add = root.findViewById(R.id.btn_food_add);
        btn_clear = root.findViewById(R.id.btn_clear);
        btn_delete = root.findViewById(R.id.btn_delete);
        btn_weight_update = root.findViewById(R.id.btn_weight_update);
        piechart = root.findViewById(R.id.piechart);
        tv_protein = root.findViewById(R.id.tv_protein);
        tv_carbs = root.findViewById(R.id.tv_carbs);
        tv_fat = root.findViewById(R.id.tv_fat);
        tv_weight = root.findViewById(R.id.tv_weight);
        tv_user_calories = root.findViewById(R.id.tv_user_calories);
        tv_user_protein = root.findViewById(R.id.tv_user_protein);
        tv_user_carbs = root.findViewById(R.id.tv_user_carbs);
        tv_user_fat = root.findViewById(R.id.tv_user_fat);
        cv_weightpanel = root.findViewById(R.id.cv_weightpanel);
        cv_foodpanel = root.findViewById(R.id.cv_foodpanel);
        numberPicker = root.findViewById(R.id.numberPicker);
        lv_foodList = root.findViewById(R.id.lv_foodList);
        lv_latestList = root.findViewById(R.id.lv_latestList);

        String email=getContext().getSharedPreferences("user_prefs", MODE_PRIVATE).getString("userEmail","test@test.com");
        UserModel user = new DataBaseHelper(getContext()).getUserByEmail(email);
        if (user != null) {
        ...
        btn_addFood.setOnClickListener(v -> {
            ...
            if (cv_foodpanel.getVisibility() == View.VISIBLE) {
                ...
                if(everyfood==null || everyfood.size()==0)
                {
                    FoodModel foodModel=new FoodModel(1,"Egg",30,"protein",1.0f,1.0f,1.0f);
                    new DataBaseHelper(getContext()).addOne(foodModel);

                    foodModel=new FoodModel(2,"Beef",30,"fat",1.0f,1.0f,1.0f);
                    new DataBaseHelper(getContext()).addOne(foodModel);
                    everyfood = dataBaseHelper.getEveryfood();
                }

                ArrayAdapter userArrayAdapter = new ArrayAdapter<FoodModel>(getContext(), android.R.layout.simple_list_item_multiple_choice, everyfood);
        ...
        btn_food_add.setOnClickListener(v -> {
            ...
            ArrayAdapter<FoodModel> latestListAdapter = new ArrayAdapter<>(getContext(),
