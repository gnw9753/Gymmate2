...
@Database(
    entities = [Exercise::class, UserEntity::class, LoginEntity::class, FoodConsumptionEntity::class, WeightEntity::class, DailyTrack::class],
    version = 1,
    exportSchema = false
)
        ...
        fun getDatabase(context: Context): GymmateEmbeddedDatabase {
            return Instance ?: synchronized(this) {
                Room.databaseBuilder(
                    context,
                    GymmateEmbeddedDatabase::class.java,
                    "gymmate_database"
                )
                    .build()
                    .also {
