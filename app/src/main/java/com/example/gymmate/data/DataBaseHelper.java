...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public boolean addOne(ExerciseModel exerciseModel) {
        ...
        cv.put(COLUMN_EXERCISE_EMAIL, exerciseModel.getEmail());
        cv.put(COLUMN_EXERCISE_DAY, exerciseModel.getDay());
        cv.put(COLUMN_EXERCISE_MUSCLE, exerciseModel.getMuscle());
        cv.put(COLUMN_EXERCISE_NAME, exerciseModel.getName());
        cv.put(COLUMN_EXERCISE_LEVEL, exerciseModel.getLevel());
        cv.put(COLUMN_EXERCISE_PART, exerciseModel.getPart());
        cv.put(COLUMN_EXERCISE_TYPE, exerciseModel.getType());
        cv.put(COLUMN_EXERCISE_MODALITY, exerciseModel.getModality());
        cv.put(COLUMN_EXERCISE_JOINT, exerciseModel.getJoint());
